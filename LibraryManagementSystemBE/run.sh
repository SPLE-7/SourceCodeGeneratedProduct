...
java -cp librarymanagementsystem.product.productdua --module-path librarymanagementsystem.product.productdua -m librarymanagementsystem.product.productdua 2>&1 | tee java.log &
JAVA_PID=$!
TEE_PID=$(pgrep -n tee)
